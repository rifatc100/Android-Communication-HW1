...
public class DownloadImagesStartedService 
    ...
    public static Intent makeIntent(Context context,
        ...
        Intent downloadImageIntent = new Intent(context.getApplicationContext(), DownloadImagesStartedService.class);
        downloadImageIntent.putExtra(REQUEST_MESSAGE, requestMessage.getMessage());
    ...
    public void onHandleIntent(Intent intent) {
        ...
        // TODO -- you fill in here.
        Uri downloadedImage = NetUtils.downloadImage(getApplicationContext(), imageURL, requestMessage.getDirectoryPathname());
